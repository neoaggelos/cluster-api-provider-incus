...
CONTAINERD_VERSION="${CONTAINERD_VERSION:-v2.1.3}"        # https://github.com/containerd/containerd
...
apt update
apt install curl iptables ethtool kmod keepalived --no-install-recommends --yes
