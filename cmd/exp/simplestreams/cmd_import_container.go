...
var (
	importContainerCmd = &cobra.Command{
		Use: "container",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if err := importContainerImage(index, products); err != nil {
				return fmt.Errorf("failed to import container image %q: %w", importCfg.imagePath, err)
			}
