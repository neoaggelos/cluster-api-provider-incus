...
```bash
kini version v0.9.1 (go1.27.1 linux/amd64)
kind version v0.33.0 (default image kindest/node:v1.37.0@sha256:a1ed56cfb0e7b93589bdf97c8cd566405a265939e3620fc4f5de89adff580ae5)
```
